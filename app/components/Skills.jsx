    ...
    <>
      <section className='flex flex-1 flex-col my-[2rem]  px-[1rem] md:px-[2rem] pb-0'>
        <div className='m-auto border border-red-800  md:w-[80%] w-[100%] font-appleMedium px-[4rem] py-[3rem] flex flex-col items-center  text-left'>
          ...
          >
            <h1 className='text-[6rem] font-appleBold' >Skills</h1>
            {/* Icon */}
          ...
          <div className='grid lg:grid-cols-4  grid-cols-2  mt-4 p-2 flex-warp border w-[100%]  items-center '>
            {collection.map((elem) => {
              ...
              return (
                <>
                  <div className='border flex place-items-center flex-col p-2 h-[40] my-2 mx-2 '>
                    <Image className='w-[80%] text-center' src={image} />
